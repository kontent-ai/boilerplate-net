...
namespace Kentico.Kontent.Boilerplate.Tests
{
    public class CachedDeliveryClientTests
    {
        ...
        {
            Assert.Contains(new IdentifierSet { Codename = "coffee_beverages_explained", Type = CacheHelper.CONTENT_ITEM_SINGLE_IDENTIFIER }, dependencies);
            Assert.Contains(new IdentifierSet { Codename = "coffee_beverages_explained", Type = CacheHelper.CONTENT_ITEM_SINGLE_JSON_IDENTIFIER }, dependencies);
            Assert.Contains(new IdentifierSet { Codename = "coffee_beverages_explained", Type = CacheHelper.CONTENT_ITEM_SINGLE_TYPED_IDENTIFIER }, dependencies);
            Assert.Contains(new IdentifierSet { Codename = "coffee_beverages_explained", Type = CacheHelper.CONTENT_ITEM_SINGLE_RUNTIME_TYPED_IDENTIFIER }, dependencies);
            Assert.Contains(new IdentifierSet { Codename = "coffee_beverages_explained", Type = CacheHelper.CONTENT_ITEM_VARIANT_SINGLE_IDENTIFIER }, dependencies);
            Assert.Contains(new IdentifierSet { Codename = "americano", Type = CacheHelper.CONTENT_ITEM_SINGLE_IDENTIFIER }, dependencies);
            Assert.Contains(new IdentifierSet { Codename = "how_to_make_a_cappuccino", Type = CacheHelper.CONTENT_ITEM_SINGLE_IDENTIFIER }, dependencies);
            Assert.Contains(new IdentifierSet { Codename = "personas", Type = CacheHelper.TAXONOMY_GROUP_SINGLE_IDENTIFIER }, dependencies);
